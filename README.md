# blogs
<strong>之前写了一偏关于[构建活动页](https://github.com/muwoo/blogs/issues/36)的文章，很多小伙伴都来私信实现的效果和原理，考虑到涉及到业务和商业问题，暂时不能公开源码和效果图。但是本人已经开始在筹备重新做一套活动页构建工具，预计1-2周可以完成核心部分，敬请期待~</strong>
